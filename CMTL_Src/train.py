from CMTL_Src.data_loader import ImageDataLoader
from CMTL_Src.model import *
...
data_loader = ImageDataLoader(train_path, train_gt_path, shuffle=True, num_classes=num_class, batch_size=batch_zie)
data_loader_val = ImageDataLoader(val_path, val_gt_path, shuffle=False, num_classes=num_class, batch_size=batch_zie)
data_loader_test = ImageDataLoader(test_path, test_gt_path, shuffle=False, num_classes=num_class, batch_size=batch_zie)
